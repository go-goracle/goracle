...
static PyTypeObject g_BaseVarType = {
    ...
    "cx_Oracle_dbg._BASEVARTYPE",           // tp_name
...
{
    TRACE("Variable_TypeByPythonType");
...
{
    TRACE("Variable_TypeByOracleDataType");
    char buffer[100];
...
{
    TRACE("Variable_TypeByOracleDescriptor");
    ub1 charsetForm;
    ub2 dataType;
    sword status;
...
static udt_Variable *Variable_DefaultNewByValue(
    ...
    unsigned numElements)               // number of elements to allocate
{
    TRACE("Variable_DefaultNewByValue");
    udt_VariableType *varType;
    udt_Variable *var;
    ub4 size = 0;
...
static udt_Variable *Variable_NewByInputTypeHandler(
    ...
    unsigned numElements)               // number of elements to allocate
{
    TRACE("Variable_NewByInputTypeHandler");
    PyObject *var;
...
{
    TRACE("VariableNewByOutputTypeHandler");
    udt_Variable *var;
    PyObject *result;
    ub4 nameLength;
    sb2 precision;
...
static PyObject *Variable_ExternalSetValue(
    ...
    PyObject *args)                     // arguments
{
    TRACE("Variable_ExternalSetValue");
    PyObject *value;
    unsigned pos;
...
{
    TRACE("Variable_ExternalGetValue");
